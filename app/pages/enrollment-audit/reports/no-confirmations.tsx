  ...
  return (
    <EnrollmentLayout title="Enrollment – No Confirmations">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-base font-semibold text-gray-800">Enrollments with No Confirmations</h2>
        ...
        <div className="overflow-x-auto rounded border border-gray-200">
          <table className="w-full text-xs">
            ...
            <tbody className="divide-y divide-gray-100 bg-white">
              {rows.length === 0 ? (
                <tr><td colSpan={13} className="px-3 py-6 text-center text-gray-400">No records</td></tr>
              ) : rows.map((r, i) => (
