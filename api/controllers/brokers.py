...
async def create_broker(data: dict, db: AsyncSession):
    query = text(
        ...
        INSERT INTO broker_new (
            ...
            pricing_email, daily_pricing_email1, ameripower_mills1,
            daily_pricing_email2, ameripower_mills2,
            daily_pricing_email3, ameripower_mills3,
            daily_pricing_email4, ameripower_mills4,
            daily_pricing_email5, ameripower_mills5,
...
async def update_broker(sid: int, data: dict, db: AsyncSession):
    ...
    UPDATE broker_new SET
        ...
        daily_pricing_email1=:daily_pricing_email1, ameripower_mills1=:ameripower_mills1,
        daily_pricing_flag1=:daily_pricing_flag1,
        daily_pricing_email2=:daily_pricing_email2, ameripower_mills2=:ameripower_mills2,
        daily_pricing_flag2=:daily_pricing_flag2,
        daily_pricing_email3=:daily_pricing_email3, ameripower_mills3=:ameripower_mills3,
        daily_pricing_flag3=:daily_pricing_flag3,
        daily_pricing_email4=:daily_pricing_email4, ameripower_mills4=:ameripower_mills4,
        daily_pricing_flag4=:daily_pricing_flag4,
        daily_pricing_email5=:daily_pricing_email5, ameripower_mills5=:ameripower_mills5,
